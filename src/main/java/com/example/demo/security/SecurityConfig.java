...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .httpBasic().disable() // it disabled some defaults: HTTP Basic authentication,
                .csrf().disable() // CSRF protection,
                .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)  //  and session cookie creation
                .and()
                .authorizeRequests()
